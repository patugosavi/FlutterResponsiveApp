  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text(
          "Welcome to Pizza Hub, your premier online pizza destination! Indulge in a symphony of flacors with our diverse menu. Customize your perfect pizza, explore tempting sides, and enjoy a seamless ordering experience. Join us in savoring excelence -  Welcome to a world of taste,welcome to Pizza Hub!",
